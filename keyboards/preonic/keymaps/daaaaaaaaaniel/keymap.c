...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    ROPT_T(KC_BSPC),
  ...
  _______, KC_LCTL, KC_LOPT, KC_LCMD, LT(_LOWER, KC_DEL), SFT_T(KC_SPC), SFT_T(KC_SPC), LT(_RAISE, KC_BSPC), RCMD_T(KC_LBRC), ROPT_T(KC_RBRC), RCTL_T(KC_BSLS), KC_EQL
),
