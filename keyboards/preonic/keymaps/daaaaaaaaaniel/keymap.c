...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  _______, KC_LCTL, KC_LOPT, KC_LCMD, LT(_LOWER, KC_DEL), KC_SPC, KC_SPC, LT(_RAISE, KC_BSPC), RCMD_T(KC_LBRC), ROPT_T(KC_RBRC), RCTL_T(KC_BSLS), KC_EQL
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_GRV,  _______, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_PSLS, KC_MINS, KC_UP,   KC_LBRC, KC_RBRC, KC_RCMD,
  KC_DEL,  KC_PDOT, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_PAST, KC_LEFT, KC_DOWN, KC_RGHT, KC_RBRC, KC_ROPT,
